...
//下面是步进电机驱动相关事件
#define HAL_STEP_MOTOR_EVT    0x0010   // 步进电机步进事件
#define HAL_STEP_MOTOR_ROUND_TRIP_FINISH_EVT   0x0020   //步时电机往复运动结束
  
// 下面是人体检测相关事件  
#define HAL_BODY_DETECT_EVT       0x0040    //人体检测事件
#define HAL_SCAN_DELAY_FINISH_EVT        0X0080    // 扫描延时结束事件

#define HAL_LIGHT_DETECT_EVT      0X0100  // 光敏检测
#define HAL_SWITCH_DETECT_EVT     0x0200  // 开关

#define HAL_LIGTH_DELAY_SCAN_EVT  0X0400  // 光照强度延时检测  
